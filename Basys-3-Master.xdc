...
set_property PACKAGE_PIN W5 [get_ports clk]
	...
	#create_clock -addBasys-3-Master.xdc -name sys_clk_pin -period 10.00 -waveform {0 5} [get_ports clk]
...
##Quad SPI Flash
##Note that CCLK_0 cANODnot be placed in 7 series devices. You cANOD access it using the
##STARTUPE2 primitive.
...
## Configuration options, cANOD be used for all designs
